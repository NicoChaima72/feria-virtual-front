          ...
          {loadingAuctions ? (
            ...
            <div className="pt-4 space-y-4 bg-gray-50">
              {auctions.map((auction) => (
                <div className="border rounded p-3 border-gray-600" key={auction.Producer.id}>
                  <div className="mt-2">
              ...
              {optionSelected == 1 ? (
                <div className="mt-4 mb-6">
                  <p className="text-green-700">
                    IMPORTANTE: Al momento de aceptar automaticamente comenzará
                    la subasta para los transportistas, por favor indica la
