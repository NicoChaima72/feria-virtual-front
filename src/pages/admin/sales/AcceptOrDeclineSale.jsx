  ...
  const handleSubmit = async (e) => {
    ...
    if (optionSelected === 1) {
      const { meta } = await dispatch(
        acceptAdminSale({ saleId: sale_id, auctionDuration: auction_duration })
      );
              ...
              {optionSelected == 1 ? (
                <div className="mt-4 mb-6">
                  <p className="text-green-700">
                    ...
                    comenzará la subasta para los productores, por favor indica
...
export default AcceptOrDeclineSale;
