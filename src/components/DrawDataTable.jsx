      ...
      // },
      {
        ...
        cell: ({ cell }) => (
          <div className="flex space-x-1">
            <Link to={`/admin/users/locals/${cell.row.original.id}/edit`}
              type="button"
            ...
            <button
              ...
              onClick={() =>
                confirm(
                  `Dar de ${cell.row.original.status == 1 ? 'BAJA' : 'ALTA'} a ${JSON.stringify(
  ...
  if (type === "externals") {
    columns = [
      ...
      // },
      {
        ...
        cell: ({ cell }) => (
          <div className="flex space-x-1">
            <Link to={`/admin/users/externals/${cell.row.original.id}/edit`}
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 rounded px-2 py-1.5"
              title="Editar"
              onClick={() => dispatch(onActiveUser(cell.row.original))}
  ...
  if (type === "transportists") {
    columns = [
      ...
      // },
      {
        ...
        cell: ({ cell }) => (
          <div className="flex space-x-1">
            <Link to={`/admin/users/transportists/${cell.row.original.id}/edit`}
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 rounded px-2 py-1.5"
              title="Editar"
              onClick={() => dispatch(onActiveUser(cell.row.original))}
